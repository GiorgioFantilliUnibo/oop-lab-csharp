...
namespace ExtensionMethods
{
    ...
    public static class ComplexExtensions
    {
        ...
        /// </summary>
        /// <param name="c">the first operand.</param>
        /// <param name="scalar">the second operand.</param>
        /// <returns>the product.</returns>
        public static IComplex Multiply(this IComplex c, double scalar) =>
        ...
        /// <summary>
        /// Divide a complex with a scalar.
        /// </summary>
        /// <param name="c">the first operand.</param>
        /// <param name="scalar">the second operand.</param>
        /// <returns>the quotient.</returns>
        public static IComplex Divide(this IComplex c, double scalar) =>
            c.Multiply(1.0 / scalar);
